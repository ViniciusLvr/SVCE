        ...
        <form method="post" class="border p-4 rounded shadow-sm bg-light mb-5">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-2" id="campoCPF">
                    <input type="text" class="form-control cpf" name="cpf" placeholder="CPF" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}">
                </div>
                <div class="col-md-2" id="campoCNPJ" style="display:none;">
                    <input type="text" class="form-control cnpj" name="cnpj" placeholder="CNPJ" pattern="\d{2}\.\d{3}\.\d{3}/\d{4}-\d{2}">
                </div>
                <div class="col-md-3">
                    <input type="text" name="telefone" class="form-control telefone" placeholder="Telefone" pattern="\(\d{2}\)\s\d{4,5}-\d{4}" title="Digite apenas números (10 ou 11 dígitos)" required>
                </div>
